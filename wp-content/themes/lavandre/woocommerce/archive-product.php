...
<div class="full-width-banner-block">
    <a class="full-width-banner-block__link" href="/product/organic-facial/">
        <figure class="overlay-text">
            <img class="cover-image" src="https://lavandre.com/wp-content/uploads/2021/09/mauro-lima-nfqDGE2WVGs-unsplash-scaled.jpeg" alt="">
    ...
    <a class="full-width-banner-block__link" href="/product/organic-towel/">
        <figure class="overlay-text">
            <img class="cover-image" src="https://lavandre.com/wp-content/uploads/2021/09/pexels-agafonova-photo-5284980-scaled.jpeg" alt="">
    ...
    <a class="full-width-banner-block__link" href="/product/organic-bath-towel/" id="bath-towel">
        <figure class="overlay-text">
            <img class="cover-image" src="https://lavandre.com/wp-content/uploads/2021/09/pexels-agafonova-photo-5276984-scaled.jpeg" alt="">
            <figcaption><?php _e('Shop body towels', 'lavandre'); ?></figcaption>
        </figure>
    </a>

    <div class="full-width-banner-block__see-more">
        <a href="#shop-now" class="no-button" data-scroll-to="bath-towel" data-header-offset="false">
