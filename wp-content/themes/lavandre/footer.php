    ...
    <section class="ww-footer__middle">
        <div class="ww-container flex">
                ...
                <ul class="contactoption-list no-list flex">
                    ...
                    <li class="contactoption-list__item">
                        <a class="contactoption-list__anchor" href="tel:<?php echo $contactPoint->getInternationalPhoneNumber()?>" target="_blank" rel="noopener">
                            ...
                            <span class="contactoption-list__text"><strong class="contactoption-list__title"><?php echo sprintf(__('Call %s', 'hello-elementor-child'), $contactPoint->getPhoneNumber()); ?></strong> <?php _e('available till 21:00', 'hello-elementor-child'); ?></span>
                        </a>
                    </li>
                    <li class="contactoption-list__item">
            ...
            <div class="ww-footer__subscribe flex flex-column flex-col-xs-12 flex-col-md-4">
                <h3 class="footer__h3"><?php _e('Subscribe to our newsletter', 'hello-elementor-child'); ?></h3>
