    ...
    <div class="full-width-banner-block__link">
        ...
        <div id="login-register-form" class="customer-account-wrapper">
            <section class="login-wrapper">
                ...
                <form id="ajax-login-form" is="login-form" class="woocommerce-form woocommerce-form-login login" data-redirect="true" data-redirect-url="/checkout/" method="post" data-field-validation autocomplete="off">
