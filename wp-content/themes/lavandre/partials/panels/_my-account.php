                ...
                <form id="ajax-login-form" class="woocommerce-form woocommerce-form-login login" method="post"
                    ...
                    <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                        <input type="email" id="ajax-login-username"
                            ...
                            placeholder="<?php _e('Email', 'lavandre'); ?>" autocomplete="username"
                            title="<?php _e('Fill in a valid email', 'lavandre'); ?>" required>
                        <label for="ajax-login-username"><?php _e('Email', 'lavandre'); ?>&nbsp;<span
                    ...
                    <p class="password-row woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                        <input type="password" id="ajax-login-password"
                            ...
                            title="<?php _e('Fill in a valid password', 'lavandre'); ?>" required>
                        <label for="ajax-login-password"><?php _e('Password', 'lavandre'); ?>&nbsp;<span
                                class="required">*</span></label>
                    </p>

                    <p class="woocommerce-LostPassword lost_password">
                        <a class="accent-link" href="/my-account/lost-password/"
                            data-role="password-forget"><?php _e('Forgot password?', 'lavandre'); ?></a>
                    </p>
                ...
                <form id="ajax-register-form" class="woocommerce-form woocommerce-form-login login" method="post"
                    ...
                    <div class="flex customer-register__name-fields">
                        <p class="form-row form-row-first customer-register__name-field">
                            <input type="text" name="first_name" id="user_first_name" class="input-text"
                                placeholder="<?php _e('First name', 'lavandre'); ?>" required
                                title="<?php _e('Fill in your first name', 'lavandre'); ?>">
                            <label for="user_first_name"><?php _e('First name', 'lavandre'); ?> <span
                                    class="required">*</span></label>
                        </p>

                        <p class="form-row form-row-last customer-register__name-field">
                            <input type="text" class="input-text" name="last_name" id="user_last_name"
                                placeholder="<?php _e('Last name', 'lavandre'); ?>" required
                                title="<?php _e('Fill in your last name', 'lavandre'); ?>">
                            <label for="user_last_name"><?php _e('Last name', 'lavandre'); ?> <span
                                    class="required">*</span></label>
                        </p>
                    </div>
                    ...
                    <p class="password-row woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                        <input class="woocommerce-Inputt woocommerce-Input--text input-text" type="password"
                            ...
                            data-value-missing="<?php _e('Fill in a valid password', 'lavandre'); ?>"
                            pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" required>
                        <label for="register-password"><?php _e('Password', 'lavandre'); ?>&nbsp;<span
                                class="required">*</span></label>
                    </p>
                    ...
                    <p class="password-row woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                        <input class="woocommerce-Inputt woocommerce-Input--text input-text" type="password"
                            ...
                            data-value-missing="<?php _e('Fill in a valid password', 'lavandre'); ?>"
                            pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}">
                        <label for="confirm-password"><?php _e('Confirm password', 'lavandre'); ?>&nbsp;<span
                                class="required">*</span></label>
                    </p>

                    <button type="submit" is="lavandre-button" outline full-width size="large" name="register"
                        value="<?php _e('Register', 'lavandre'); ?>"><?php _e('Register', 'lavandre'); ?></button>
                </form>
            </section>
        </div>
    </dialog>
